			...
			<view class="colonn">
				<view class="colonn">
					...
					<view class="iteminfviewi roww center_center">
						<view class="lefttitle">主机功率</view>
						<view class="allline"></view>
						<picker :range="goodInfo1[0]" range-key="name" @change="goodsChange(0,index1,$event)">
				...
				<view class="colonn">
					<view class="h-25"></view>
					<view class="iteminfviewi roww center_center">
						<view class="lefttitle">应用温度</view>
						<view class="allline"></view>
						<view class="huanhang w-500 endend">
	...
	export default {
		...
		methods: {
			...
			goodsChange(index, index1, txt,id){
				...
				console.log("===",txt);    
				console.log("===1",index, index1, txt,id);   
				this.selClick(index, index1, txt,id);
			},     
			selClick(index, index1, txt,id) {
				console.log("---",index, index1, txt,id);
				return false;  
